...
export const Map = () => {
  ...
  return (
    <GoogleMap style={{display: 'none'}} mapContainerStyle={mapContainerStyle} zoom={8} center={center} options={options} onLoad={onMapLoad}>
      {requestArr.data.map((request) => (
        <Marker
          ...
          icon = {{
            url: `http://maps.google.com/mapfiles/ms/icons/${request.status === "unfulfilled" ? `pink-dot` : `green-dot`}.png`,
